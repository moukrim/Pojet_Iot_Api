...
char pass[] = "33333333";    
//int keyIndex = 0;            
char servername[]="192.168.137.207";
...
void postValues(){
  char data[64];
    ...
    int light = getLight();/*
    sprintf(data, "s=%s&l=%d&h=%d", "salle224",  light, humidity );
        Serial.println(data);
        client.println("POST /projet_iot/php/test.php HTTP/1.1");
        ...
        client.print(data);
      */
    client.print("GET /projet_iot/php/insertPlante.php?nA=arduino1&nP=cactus&l=");
    client.print(light);
    client.print("&h=");
    client.print(humidity);
    client.print("&i=cactus");
